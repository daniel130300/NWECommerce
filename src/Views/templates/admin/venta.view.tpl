<section class="container d-flex align-items-center justify-content-center">
    <div class="card my-5 w-100">
      ...
      <div class="card-body"> 
        ...
        {{foreach ProductoTotal}}
        <div class="form-group col-md-5">
            <label for="VentaSubtotal">SubTotal</label>
            <input type="text" class="form-control" readonly id="VentaSubtotal" name="VentaSubtotal" value="{{VentaSubtotal}}" maxlength="80">
        </div>

        <div class="form-group col-md-5">
           <label for="VentaTotal">Total</label>
           <input type="text" class="form-control" readonly id="VentaTotal" name="VentaTotal" value="{{VentaTotal}}" maxlength="80">
        </div>
        {{endfor ProductoTotal}}
